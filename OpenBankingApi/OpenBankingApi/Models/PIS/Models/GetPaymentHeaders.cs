...
namespace Api.Models.PIS
{
    ...
    /// <summary>
    /// Defines headers for getPayment operation.
    /// </summary>
    public partial class GetPaymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetPaymentHeaders class.
        /// </summary>
        public GetPaymentHeaders()
        {
            CustomInit();
        }
        ...
        /// the response</param>
        public GetPaymentHeaders(string xJWSSIGNATURE = default(string))
        {
