...
namespace Api.Models.PIS
{
    ...
    /// <summary>
    /// Defines headers for domestic operation.
    /// </summary>
    public partial class DomesticHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DomesticHeaders class.
        /// </summary>
        public DomesticHeaders()
        {
            CustomInit();
        }
        ...
        /// the response</param>
        public DomesticHeaders(string xJWSSIGNATURE = default(string))
        {
