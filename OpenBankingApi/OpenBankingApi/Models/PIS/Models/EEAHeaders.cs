...
namespace Api.Models.PIS
{
    ...
    /// <summary>
    /// Defines headers for EEA operation.
    /// </summary>
    public partial class EEAHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EEAHeaders class.
        /// </summary>
        public EEAHeaders()
        {
            CustomInit();
        ...
        /// the response</param>
        public EEAHeaders(string xJWSSIGNATURE = default(string))
        {
