...
namespace Api.Models.PIS
{
    ...
    public partial class Bank
    {
        ...
        public Bank(string bicOrSwift = default(string), string name = default(string), string code = default(string), string countryCode = default(string), IList<string> address = default(IList<string>))
        {
