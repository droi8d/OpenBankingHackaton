...
namespace Api.Models.PIS
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RequestHeader class.
        /// </summary>
        ...
        public RequestHeader(string token, string requestId = default(string), string userAgent = default(string), string ipAddress = default(string), string sendDate = default(string), string tppId = default(string))
        {
            RequestId = requestId;
            UserAgent = userAgent;
            IpAddress = ipAddress;
