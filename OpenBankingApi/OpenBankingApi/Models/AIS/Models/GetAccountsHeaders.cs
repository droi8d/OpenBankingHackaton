...
namespace Api.Models.AIS.Models
{
    ...
    /// <summary>
    /// Defines headers for getAccounts operation.
    /// </summary>
    public partial class GetAccountsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAccountsHeaders class.
        /// </summary>
        public GetAccountsHeaders()
        {
            CustomInit();
        }
        ...
        /// the response</param>
        public GetAccountsHeaders(string contentEncoding = default(string), string xJWSSIGNATURE = default(string))
        {
