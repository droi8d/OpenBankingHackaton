...
namespace Api.Models.AIS.Models
{
    ...
    /// <summary>
    /// Defines headers for getAccount operation.
    /// </summary>
    public partial class GetAccountHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAccountHeaders class.
        /// </summary>
        public GetAccountHeaders()
        {
            CustomInit();
        }
        ...
        /// the response</param>
        public GetAccountHeaders(string contentEncoding = default(string), string xJWSSIGNATURE = default(string))
        {
