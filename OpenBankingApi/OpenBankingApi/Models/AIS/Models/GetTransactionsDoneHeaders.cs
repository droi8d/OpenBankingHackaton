...
namespace Api.Models.AIS.Models
{
    ...
    /// <summary>
    /// Defines headers for getTransactionsDone operation.
    /// </summary>
    public partial class GetTransactionsDoneHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTransactionsDoneHeaders class.
        /// </summary>
        public GetTransactionsDoneHeaders()
        {
            CustomInit();
        }
        ...
        /// the response</param>
        public GetTransactionsDoneHeaders(string contentEncoding = default(string), string xJWSSIGNATURE = default(string))
        {
